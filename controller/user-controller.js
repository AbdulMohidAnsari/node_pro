...
const userRegisteration = async (req, res) => {
    console.log("one")
    // console.log(req)
    const { name, email, contact, password, Confirmpassword, date } = req.body;
...
module.exports = { userRegisteration, login, changepassword, loggeduser, changeUserPasswordbyEmailLink, resetUserPasswordbyLink }   